...
class PatientInformation(models.Model):
    ...
    maratial_status = models.CharField('* Marital Status', max_length=10, blank=True, null=True)
    snn = models.CharField('* SNN', max_length=20, validators=[ssnValidation], blank=True, null=True, help_text= '(use format: XXX-XX-XXXX)')
    preferred_language = models.CharField('* Preferred Language', max_length=20, blank=True, null=True)
